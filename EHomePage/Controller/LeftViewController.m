...
-(void)changeRootViewAction{
    ...
    CollectionViewController *mainViewController=[storyboard instantiateViewControllerWithIdentifier:NSStringFromClass([CollectionViewController class])];
    CGFloat randomR=arc4random()%255/255.0f;
    [mainViewController.view setBackgroundColor:[UIColor colorWithRed:randomR green:0.8 blue:0.8 alpha:1]];
